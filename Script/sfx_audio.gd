...
var bot_wheel_attack = preload("res://Sound/Sound Effects/BotWheelAttack.wav")
var bot_wheel_damage = preload("res://Sound/Sound Effects/BotWheelDamage.wav")
var drone_zapper_attack = preload("res://Sound/Sound Effects/DroneZapperAttack.wav")

var button_click = preload("res://Sound/Sound Effects/ButtonClick.wav")
...
func play_player_sfx(sfx_name: String):
	...
	elif sfx_name == "player_damage":
		stream = player_damage
	elif sfx_name == "button_click":
		stream = button_click
	else:
...
func play_enemy_sfx(sfx_name: String):
	var stream = null
	if sfx_name == "enemy_damage":
		stream = bot_wheel_damage
	elif sfx_name == "bot_wheel_attack":
		stream = bot_wheel_attack
	elif sfx_name == "drone_zapper_attack":
		stream = drone_zapper_attack
	else:
		print("Invalid sound effect name")
